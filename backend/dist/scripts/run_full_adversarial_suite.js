...
exports.ADVERSARIAL_50_CASES = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
exports.ADVERSARIAL_50_CASES = [
    {
...
async function runSuite() {
    ...
    console.log('================================================================================\n');
    let totalCases = exports.ADVERSARIAL_50_CASES.length;
    let passedCases = 0;
    let falsePositives = 0;
    let absErrors = [];
    const results = [];
    for (const tc of exports.ADVERSARIAL_50_CASES) {
        const payload = {
            ...
            candidate_profile: {
                ...
                educations: [],
                work_experiences: (tc.candidateData.experiences || []).map((e) => ({
...
//# sourceMappingURL=run_full_adversarial_suite.js.map