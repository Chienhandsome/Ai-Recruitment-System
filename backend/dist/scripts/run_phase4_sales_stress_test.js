...
exports.CANDIDATES_PHASE_4_6 = [
    {
        ...
        work_experiences: [
            ...
            },
            {
                ...
                end_date: '2016-05-30',
                description: '• Trực tiếp tiếp cận, chào hàng dòng sản phẩm giải pháp ẩm thực (Food Solutions) cho các nhà hàng, quán cà phê và bếp ăn thương mại.\n• Duy trì quan hệ và chăm sóc danh mục 80 khách hàng trọng điểm.\n• Đàm phán đơn hàng và theo dõi giao nhận đúng tiến độ.',
                achievements: '• Luôn hoàn thành 105% - 110% chỉ tiêu doanh thu cá nhân hàng quý.',
            },
        ],
        skills: [
    ...
    },
    {
        ...
        summary: 'Hơn 10 năm chỉ đạo và điều tiết mạng lưới lưu thông sản phẩm tiêu dùng thực phẩm đóng gói. Từng dẫn dắt tổ hợp hơn 20 chuyên viên thương mại thực địa tại miền Nam. Chuyên sâu về cơ chế quản trị đối tác bán buôn cấp tỉnh, cân đối dòng hàng xuất - nhập điểm bán, giải phóng tồn đọng kho bãi và thiết lập hợp đồng cung ứng dài hạn cho hệ thống dịch vụ ẩm thực lưu trú.',
        expectedLevel: 'HIGH',
    ...
    },
    {
        ...
        summary: 'Chuyên gia Sales Management, Business Development, FMCG, Horeca, Foodservice, Distributor Management, Sales Forecasting, Leadership, Commercial Negotiation, Market Analysis, Target-driven với hơn 6 năm kinh nghiệm trong ngành hàng tiêu dùng nhanh thực phẩm và đồ uống.',
        expectedLevel: 'LOW',
        expectedOrderTier: 'Tier 4 (Low / False Match Trap)',
        profile: {
            desired_title: 'Area Sales Manager / Sales Management Specialist',
            professional_summary: 'Chuyên gia Sales Management, Business Development, FMCG, Horeca, Foodservice, Distributor Management, Sales Forecasting, Leadership, Commercial Negotiation, Market Analysis, Target-driven với hơn 6 năm kinh nghiệm trong ngành hàng tiêu dùng nhanh thực phẩm và đồ uống.',
        },
        educations: [
            {
        ...
        work_experiences: [
            ...
            },
            {
                ...
                end_date: '2021-03-31',
                description: '• Thực hiện cuộc gọi theo danh sách dữ liệu có sẵn (data call) để giới thiệu danh mục siro, trà và nguyên liệu pha chế cho các quán cà phê nhỏ.\n• Tư vấn chương trình khuyến mại tháng và chốt đơn đặt hàng trực tiếp qua điện thoại.\n• Lưu trữ thông tin phản hồi của khách hàng lên hệ thống phần mềm CRM.',
                achievements: '• Đạt chỉ tiêu gọi 65 cuộc gọi/ngày và duy trì tỷ lệ chốt đơn thành công 12% trên danh sách khách hàng tiềm năng.',
            },
        ],
        skills: [
    ...
    },
    {
        ...
        profile: {
            ...
            professional_summary: '7.5 năm kinh nghiệm làm việc trong ngành FMCG Sữa & Thực phẩm dinh dưỡng. Có 5.5 năm làm Sales Executive xuất sắc và 2.0 năm giữ vị trí Giám sát Bán hàng Khu vực (Territory Sales Supervisor) quản lý đội ngũ 7 nhân viên tại Vinamilk. Đàm phán tốt kênh Horeca và đại lý bán lẻ, đạt 108% target doanh thu liên tục. Mong muốn phát triển lên vị trí Quản lý Kinh doanh Khu vực (ASM).',
        },
        educations: [
            {
        ...
        work_experiences: [
            ...
            },
            {
                ...
                end_date: '2018-12-31',
                description: '• Đi tuyến thị trường hàng ngày, chào bán các dòng sữa bột và ngũ cốc dinh dưỡng cho cửa hàng mẹ và bé.\n• Đạt chỉ tiêu viếng thăm 25 điểm bán/ngày.',
                achievements: '• Luôn hoàn thành 100% KPI điểm bán viếng thăm và đơn hàng thành công.',
            },
        ],
        skills: [
    ...
    },
    {
        ...
        summary: '8.5 năm kinh nghiệm phân phối và kinh doanh bất động sản thương mại, đất nền và căn hộ cao cấp tại TP.HCM & Bình Dương. Hơn 6.0 năm làm Trưởng phòng Kinh doanh BĐS tại Đất Xanh Group và Novaland. Quản lý trực tiếp sàn giao dịch gồm 22 chuyên viên môi giới bất động sản B2C. Kỹ năng đàm phán hợp đồng cọc hàng chục tỷ đồng, tổ chức sự kiện mở bán tập trung, phân bổ chỉ tiêu doanh số môi giới.',
        expectedLevel: 'LOW',
        expectedOrderTier: 'Tier 4 (Wrong Domain / Low Fit)',
        profile: {
            desired_title: 'Giám Đốc Sàn Giao Dịch / Trưởng Phòng Kinh Doanh Bất Động Sản',
            professional_summary: '8.5 năm kinh nghiệm phân phối và kinh doanh bất động sản thương mại, đất nền và căn hộ cao cấp tại TP.HCM & Bình Dương. Hơn 6.0 năm làm Trưởng phòng Kinh doanh BĐS tại Đất Xanh Group và Novaland. Quản lý trực tiếp sàn giao dịch gồm 22 chuyên viên môi giới bất động sản B2C. Kỹ năng đàm phán hợp đồng cọc hàng chục tỷ đồng, tổ chức sự kiện mở bán tập trung, phân bổ chỉ tiêu doanh số môi giới.',
        },
        educations: [
            {
        ...
        work_experiences: [
            ...
            },
            {
                ...
                end_date: '2019-08-31',
                description: '• Tìm kiếm, mở rộng tệp khách hàng cá nhân có dòng tiền nhàn rỗi đầu tư dự án căn hộ hạng sang và shophouse.\n• Tổ chức tiếp khách tại nhà mẫu và hỗ trợ hoàn tất thủ tục vay vốn ngân hàng bảo lãnh dự án.',
                achievements: '• Chốt thành công 28 giao dịch căn hộ cao cấp và shophouse, đạt doanh thu phí cá nhân thuộc Top 5 của sàn.',
            },
        ],
        skills: [
    ...
    },
    {
        ...
        summary: '8.5 năm kinh nghiệm quản lý kinh doanh địa bàn trong ngành Dược phẩm & Thiết bị Y tế (Sanofi, Zuellig Pharma). Hơn 5.5 năm làm Quản lý Kinh doanh Khu vực (Area Sales Manager) phụ trách kênh ETC (Bệnh viện lớn) và OTC (Nhà thuốc & Chuỗi bán lẻ Dược). Quản lý đội ngũ 14 Trình dược viên và Giám sát viên, phụ trách doanh thu 85 tỷ VND/năm tại TP.HCM và các tỉnh lân cận. Am hiểu sâu sắc về quản trị đại lý phân phối thuốc, dự báo nhu cầu sản lượng theo mùa và đàm phán hợp đồng thầu thương mại.',
        expectedLevel: 'MEDIUM',
        expectedOrderTier: 'Tier 2 / Tier 3 (Transferable Moderate Match)',
        profile: {
            desired_title: 'Area Sales Manager / Territory Commercial Manager',
            professional_summary: '8.5 năm kinh nghiệm quản lý kinh doanh địa bàn trong ngành Dược phẩm & Thiết bị Y tế (Sanofi, Zuellig Pharma). Hơn 5.5 năm làm Quản lý Kinh doanh Khu vực (Area Sales Manager) phụ trách kênh ETC (Bệnh viện lớn) và OTC (Nhà thuốc & Chuỗi bán lẻ Dược). Quản lý đội ngũ 14 Trình dược viên và Giám sát viên, phụ trách doanh thu 85 tỷ VND/năm tại TP.HCM và các tỉnh lân cận. Am hiểu sâu sắc về quản trị đại lý phân phối thuốc, dự báo nhu cầu sản lượng theo mùa và đàm phán hợp đồng thầu thương mại.',
        },
        educations: [
            {
        ...
        work_experiences: [
            ...
            },
            {
                ...
                start_date: '2016-08-01',
                end_date: '2019-12-31',
                description: '• Phụ trách giới thiệu sản phẩm và phát triển doanh số tại các bệnh viện tuyến quận và trung tâm y tế tại TP.HCM.\n• Xây dựng mối quan hệ chuyên môn với các bác sĩ trưởng khoa và dược sĩ nhà thuốc bệnh viện.\n• Thu thập phản hồi thị trường và thông tin đấu thầu thuốc của các đối thủ cạnh tranh.',
                achievements: '• Đạt danh hiệu Best Medical Representative miền Nam năm 2018.',
            },
        ],
        skills: [
            { skill_name: 'Quản lý Đội ngũ Sales & Giám sát Địa bàn', proficiency_level: 'ADVANCED', normalized_name: 'sales team management territory leadership' },
    ...
    },
    {
        ...
        profile: {
            ...
            professional_summary: '10.5 năm kinh nghiệm chuyên sâu trong vai trò Chuyên gia Bán hàng Cá nhân Cao cấp (Senior Key Account Executive / Key Account Manager) tại Unilever và Mondelez Kinh Đô. Chuyên trách trực tiếp đàm phán hợp đồng thương mại lớn với các chuỗi đại siêu thị Co.opmart, WinMart, Big C / Go! và Lotte Mart. Doanh số cá nhân quản lý đạt trên 80 tỷ VND/năm, liên tục vượt chỉ tiêu doanh số 7 năm liền. Năng lực đàm phán chiết khấu, khuyến mại và giải quyết tranh chấp thương mại xuất sắc. Không có kinh nghiệm quản lý đội ngũ nhân viên cấp dưới trực tiếp (Individual Contributor).',
        },
        educations: [
            {
    ...
    },
    {
        ...
        summary: 'Giám Đốc Kinh Doanh Vùng (Regional Sales Director) với hơn 6.0 năm lãnh đạo bộ phận kinh doanh tại Công ty TNHH Dịch vụ Thực phẩm Sài Gòn Xanh. Am hiểu sâu sắc về điều hành chiến lược, bao quát toàn bộ thị trường miền Nam, phụ trách mở rộng khách hàng và quản lý doanh thu.',
        expectedLevel: 'LOW',
        expectedOrderTier: 'Tier 4 (Title Inflation / Tiny Scope)',
        profile: {
            desired_title: 'Regional Sales Director / Area Sales Manager',
            professional_summary: 'Giám Đốc Kinh Doanh Vùng (Regional Sales Director) với hơn 6.0 năm lãnh đạo bộ phận kinh doanh tại Công ty TNHH Dịch vụ Thực phẩm Sài Gòn Xanh. Am hiểu sâu sắc về điều hành chiến lược, bao quát toàn bộ thị trường miền Nam, phụ trách mở rộng khách hàng và quản lý doanh thu.',
        },
        educations: [
            {
        ...
        work_experiences: [
            ...
            },
            {
                ...
                start_date: '2018-08-01',
                end_date: '2020-02-28',
                description: '• Trực tiếp đứng bán hàng tại quầy thực phẩm sạch và quản lý 1 nhân viên thu ngân.\n• Kiểm đếm số lượng hàng tồn cuối ngày và gọi điện đặt thêm hàng từ các vựa đầu mối.',
                achievements: '• Tăng lượng khách hàng quen ghé mua lẻ tại cửa hàng thêm 15%.',
            },
        ],
        skills: [
        ...
        work_experiences: [
            {
                ...
                end_date: '2025-08-30',
                description: '• Cố vấn độc lập xây dựng quy chế quản lý nhà phân phối, cơ chế chiết khấu và tiêu chuẩn đo lường KPI cho 3 doanh nghiệp thực phẩm chế biến tại miền Nam.\n• Thiết lập lại quy trình đi tuyến, hệ thống báo cáo bán hàng tự động qua app DMS cho 30 nhân viên bán hàng của đối tác.\n• Hoạt động song song với vai trò Quản lý Bán hàng Dự án bán thời gian.',
                achievements: '• Giúp đối tác nâng tỷ lệ độ phủ điểm bán thêm 28% và chuẩn hóa hệ thống 5 nhà phân phối cấp tỉnh.',
            },
            {
            ...
            },
            {
                ...
                start_date: '2013-08-01',
                end_date: '2015-12-31',
                description: '• Phát triển mạng lưới đại lý bánh kẹo và thực phẩm đóng hộp tại các tỉnh Tây Nam Bộ.',
                achievements: '• Hoàn thành chỉ tiêu doanh thu được giao.',
            },
        ],
        skills: [
            { skill_name: 'Quản lý Đội ngũ Sales & Giám sát Địa bàn', proficiency_level: 'ADVANCED', normalized_name: 'sales team management territory leadership' },
    ...
    },
    {
        ...
        work_experiences: [
            ...
            },
            {
                ...
                end_date: '2019-05-31',
                description: '• Phụ trách tổ công tác 10 đại diện bán hàng tuyến tạp hóa và quán ăn tại TP.HCM.\n• Đôn đốc chỉ tiêu ngày, kiểm tra chất lượng phục vụ và trực tiếp giải quyết vướng mắc về thanh toán của khách hàng lớn.',
                achievements: '• Luôn hoàn thành 108% chỉ tiêu sản lượng hàng tháng.',
            },
        ],
        skills: [
...
async function main() {
    ...
    const jdSkillsData = [
        { name: 'Quản lý Đội ngũ Sales & Giám sát Địa bàn (Sales Team Management & Territory Leadership)', norm: 'sales team management territory leadership', isMandatory: true, minLevel: client_1.ProficiencyLevel.EXPERT, minYears: 5 },
        { name: 'Phát triển Mạng lưới Nhà phân phối & Đại lý (Distributor & Channel Management)', norm: 'distributor channel management', isMandatory: true, minLevel: client_1.ProficiencyLevel.ADVANCED, minYears: 4 },
        { name: 'Quản trị Doanh số & Hoạch định Dự báo (Sales Target & Revenue Forecasting)', norm: 'sales target revenue forecasting', isMandatory: true, minLevel: client_1.ProficiencyLevel.ADVANCED, minYears: 4 },
        { name: 'Khai thác Thị trường Horeca & Foodservice (Horeca & Foodservice Market Penetration)', norm: 'horeca foodservice market penetration', isMandatory: true, minLevel: client_1.ProficiencyLevel.ADVANCED, minYears: 3 },
        { name: 'Đàm phán Điều khoản Thương mại & Key Account (Commercial Negotiation & Key Accounts)', norm: 'commercial negotiation key accounts', isMandatory: true, minLevel: client_1.ProficiencyLevel.ADVANCED, minYears: 4 },
        { name: 'Huấn luyện & Phát triển Năng lực Bán hàng (Sales Coaching & Field Training)', norm: 'sales coaching field training', isMandatory: false, minLevel: client_1.ProficiencyLevel.ADVANCED, minYears: 3 },
        { name: 'Phân tích Thị trường & Nghiên cứu Đối thủ (Market Analysis & Competitor Intelligence)', norm: 'market analysis competitor intelligence', isMandatory: false, minLevel: client_1.ProficiencyLevel.INTERMEDIATE, minYears: 2 },
        { name: 'Hoạch định Chiến lược Kinh doanh Khu vực (Area Business Planning & Execution)', norm: 'area business planning execution', isMandatory: false, minLevel: client_1.ProficiencyLevel.ADVANCED, minYears: 3 },
    ];
    ...
    const jobPosting = await prisma.jobPosting.upsert({
        ...
        update: {
            ...
            experienceLevel: client_1.ExperienceLevel.MANAGER,
...
• M8: Tốt nghiệp Đại học trở lên.`,
    ...
    for (const js of createdJdSkills) {
        await prisma.jobSkill.create({
            data: {
                jobId: jobPosting.id,
                skillId: js.skill.id,
                requirementType: js.isMandatory ? client_1.SkillRequirementType.MANDATORY : client_1.SkillRequirementType.PREFERRED,
    ...
    const resultsMatrix = [];
    for (const c of exports.CANDIDATES_PHASE_4_6) {
        console.log(`\n--------------------------------------------------------------------------------`);
        ...
        for (const skData of c.skills) {
            ...
            await prisma.candidateSkill.create({
                data: {
                    ...
                    skillId: skillRec.id,
                    proficiencyLevel: skData.proficiency_level || client_1.ProficiencyLevel.ADVANCED,
                    source: client_1.SkillSource.EXTRACTED,
                },
            });
        }
        ...
        for (const edu of c.educations) {
            await prisma.education.create({
                data: {
                    ...
                    source: client_1.DataSource.EXTRACTED,
                },
            });
        }
        ...
        console.log(`     • Matched Skills: ${(res.matched_skills || []).map((m) => m.name).join(', ') || 'None'}`);
...
//# sourceMappingURL=run_phase4_sales_stress_test.js.map