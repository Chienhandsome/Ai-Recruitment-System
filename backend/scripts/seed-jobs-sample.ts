...
import { PrismaClient, JobStatus, EmploymentType, ExperienceLevel } from '@prisma/client';
...
async function main() {
  ...
  // 1. Get or create Company & Department
  ...
  // 2. Get or create a Recruiter User
  ...
  const sampleJobs = [
    ...
    },
    {
      ...
      status: JobStatus.DRAFT, // Pending approval
      minSalary: 30000000,
      maxSalary: 55000000,
      currency: 'VND',
    ...
    },
    {
      ...
      status: JobStatus.PAUSED, // Suspended
      minSalary: 10000000,
      maxSalary: 15000000,
      currency: 'VND',
      location: 'Toàn quốc',
