                      ...
                      {sortedApplications.map((app: any, idx: number) => {
                        ...
                        return (
                          <div
                            ...
                            className={`p-4 rounded-xl border transition-all cursor-pointer flex flex-col md:flex-row md:items-center justify-between gap-4 ${isSelected
                          ...
                          >
                            ...
                            <div className="flex items-center gap-4 min-w-0">
                              {/* Rank badge */}
                              <div className={`w-8 h-8 rounded-lg flex items-center justify-center font-extrabold text-xs shrink-0 ${idx === 0 ? "bg-amber-100 text-amber-800 border border-amber-300" :
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              ...
                              <span className={`text-xs font-bold px-2.5 py-1 rounded-lg border ${applicationStageStyles[app.currentStage as keyof typeof applicationStageStyles] ||
                              ...
                              {evaluationPending ? (
                                ...
                                <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-xl border border-slate-200">
                                  <div className="text-right">
                                    ...
                                    <span className={`text-xl font-black ${score >= (job.autoShortlistThreshold || 80) ? "text-emerald-600" :
                      ...
                      <div className="space-y-4 pt-2">
                        ...
                        <div className="flex items-center justify-between bg-gradient-to-r from-[#1F2937] to-slate-800 text-white p-4 rounded-2xl shadow-md">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`rounded-lg border px-3 py-1 text-xs font-bold ${applicationStageStyles[activeApp.currentStage as keyof typeof applicationStageStyles]
                              }`}>
                                  ...
                                  <div className="flex items-start justify-between gap-2">
                                    <div>
                                      ...
                                      <div className="flex flex-wrap items-center gap-2 mt-1">
                                        ...
                                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded border ${item.status === 'COMPLETED'
                                        ...
                                        {item.candidateResponse && (
                                          <span className={`text-[10px] font-bold px-2 py-0.5 rounded border ${item.candidateResponse === 'ACCEPTED'
                                              ? 'bg-emerald-50 text-emerald-700 border-emerald-200'
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          ...
                          <div className="space-y-5 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                            ...
                            {!aiResult ? (
                              <div className={`rounded-xl border p-5 ${evaluationPending
                              ...
                              <>
                                ...
                                <div className="p-4 bg-gradient-to-br from-[#EFF6FF] to-blue-50 border border-blue-200 rounded-xl flex items-center justify-between">
                                  <div>
                                    ...
                                    <div className="flex items-baseline gap-2 mt-1">
                                      <span className={`text-3xl font-black ${score >= (job.autoShortlistThreshold || 80) ? "text-emerald-600" :
                                          score < (job.autoRejectThreshold || 40) ? "text-rose-600" : "text-amber-500"
                                        }`}>
                                        {score}
                                      </span>
                                  ...
                                  <div className="flex flex-col items-end gap-1.5">
                                    <span className={`text-xs font-extrabold px-3 py-1 rounded-full border ${aiResult?.matchLevel === "HIGH" ? "bg-emerald-100 text-emerald-800 border-emerald-300" :
                                ...
                                {aiResult?.requiredExperienceLevel && (
                                  <div className={`p-4 rounded-xl border space-y-3 ${aiResult.levelEligible === true
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                      ...
                                      <span className={`text-xs font-extrabold px-3 py-1 rounded-full border ${aiResult.levelEligible === true
                                      ...
                                      <div className="pt-2 border-t border-slate-200">
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                          {(aiResult?.missingSkills || []).map((sk: any, i: number) => (
                                            <span key={i} className={`px-2.5 py-1 text-xs font-bold rounded-lg border ${sk.isMandatory
                                                ? "bg-rose-100 text-rose-800 border-rose-300"
                                                : "bg-amber-100 text-amber-800 border-amber-300"
                                              }`}>
